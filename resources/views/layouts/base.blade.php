...
<body class="home-page home-01 ">
										...
										@if(Auth::user()->utype === 'ADM')
											...
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a title="Manege Home Slider" href="{{ route('admin.homeslider')}}">Manage Home Slider</a>
													</li>	
	...
	<script src="https://cdn.tiny.cloud/1/5oi712crnkfcs17d5vlhixcqi3vsykk8av6psn9erxwydjrx/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
